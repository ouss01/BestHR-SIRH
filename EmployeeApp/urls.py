...
from .views import (
    ...
    sign_in_with_token, department_api, EmployeeListCreateView, EmployeeRetrieveUpdateDestroyView,
    save_file, assign_competence_to_employee,
    ...
    employee_api,promotion_list_create
)
...
urlpatterns = [
    ...
    path('api/employees/<int:id>/', employee_api, name='employee'),
