...
class Employee(models.Model):
    ...
    employmentType = models.CharField(max_length=255, blank=True, null=True)
...
class Promotion(models.Model):
    departement = models.ForeignKey('Department', on_delete=models.CASCADE, related_name='promotions')
    employe_promotionne = models.ForeignKey('Employee', on_delete=models.CASCADE, related_name='promotions')
