    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cv', models.FileField(blank=True, null=True, upload_to='employees/cvs/', validators=[EmployeeApp.models.validate_pdf])),
                ...
                ('parentId', models.ForeignKey(blank=True, db_column='parentId', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='children', to='EmployeeApp.employee')),
            ],
        ),
        migrations.AddField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('start_date', models.DateField()),
                ('end_date', models.DateField()),
                ('departure_reason', models.CharField(default=None, help_text='Name of the departure reason', max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('task_type', models.CharField(choices=[('email', 'Email Task'), ('calendar', 'Calendar Task')], max_length=10)),
                ('description', models.TextField()),
                ('due_date', models.DateField(blank=True, null=True)),
                ('first_alert_date', models.DateField(blank=True, null=True)),
                ('second_alert_date', models.DateField(blank=True, null=True)),
                ('etape', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='tasks', to='EmployeeApp.etapeonboarding')),
            ],
        ),
        migrations.CreateModel(
            name='CustomUser',
            fields=[
                ...
                ('roles', models.CharField(choices=[('Gestionnaire RH', 'HR Manager'), ('Manager', 'Manager'), ('Employé', 'Employee')], default='employee', max_length=255, verbose_name='Roles')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('team', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='managers', to='EmployeeApp.onboarding')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('task', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='progress', to='EmployeeApp.task')),
                ('employee', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='onboarding_progress', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Notification',
            fields=[
                ...
                ('task', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='notifications', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Affectation',
